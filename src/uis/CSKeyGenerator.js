...
import ShowCSKey from './ShowCSKey';
...
export default function CSKeyGenerator({ setToken, setUsername, setIsUserSuper }) {
	...
	const onSubmit = () => {
		...
		server.getCsKey({ username:uname, password:passw, success, error });
		setPassw('');
	}
	...
	return (
		<Fragment>
			...
			<ShowCSKey csKey={csKey} setCsKey={setCsKey} />
